...
- Keep presence scoped to the smallest useful audience, preferably the same map and an interest radius. Do not broadcast every movement to every player in a shard.
