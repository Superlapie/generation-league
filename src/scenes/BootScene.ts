...
export class BootScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet('avatar-a','assets/ninja-adventure/characters/player-female.png',{frameWidth:16,frameHeight:16});
    this.load.spritesheet('avatar-b','assets/ninja-adventure/characters/player-male.png',{frameWidth:16,frameHeight:16});
    for (const npc of ['professor','assistant','healer','merchant','elder','ranger','miner','rival']) {
      this.load.spritesheet(`npc-${npc}`,`assets/ninja-adventure/characters/${npc}.png`,{frameWidth:16,frameHeight:16});
    }
